...
\subsection{Architecture hiérarchique validée}
...
\subsection{Efficacité démontrée de l'autoencodeur}
...
\subsection{Validation comparative exhaustive}
...
\subsection{Impact quantifié de SVM-SMOTE}
...
\subsection{Excellence en classification binaire}
...
\subsection{Performances contrastées en classification multi-classes}
...
\subsection{Validation de l'approche d'équilibrage}
...
\section{Limitations reconnues et défis persistants}
...
\subsection{Contraintes liées au dataset}
...
\subsection{Défis structurels des attaques sophistiquées}
...
\subsection{Limitations de l'augmentation synthétique}
...
\section{Perspectives de recherche et recommandations}
...
\subsection{Améliorations architecturales immédiates}
...
\subsection{Innovations méthodologiques futures}
...
\section{Impact et contribution à la cybersécurité}
