...
\subsection{Interprétation des performances obtenues}

\subsubsection{Efficacité de la classification binaire}
...
\subsubsection{Performance remarquable de l'autoencodeur}
...
\subsection{Analyse critique de la classification multi-classes}

\subsubsection{Déséquilibre des performances selon les types d'attaques}
...
\subsubsection{Impact et limitations de SVM-SMOTE}
...
\subsubsection{Positionnement par rapport aux approches existantes}
...
\subsubsection{Avantages de l'approche hiérarchique}
...
\subsection{Implications pour la cybersécurité opérationnelle}

\subsubsection{Déployabilité et intégration en environnement de production}
...
\subsubsection{Stratégies de mitigation pour les classes problématiques}
...
\subsection{Limitations et défis identifiés}
...
\subsubsection{Défis techniques persistants}
...
\subsection{Perspectives d'amélioration et recherches futures}
...
\subsubsection{Innovations méthodologiques}
...
\subsubsection{Directions de recherche prometteuses}
...
\subsection{Contributions et impact de la recherche}
...
\subsubsection{Impact pour la communauté scientifique}
