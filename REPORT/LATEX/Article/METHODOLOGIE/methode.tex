...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/pipeline_general.png}
...
\subsection{Jeu de données NSL-KDD}

\subsubsection{Présentation et structure}
...
\subsubsection{Description détaillée des 41 caractéristiques}
...
\paragraph{Caractéristiques de base (9 attributs)}
...
\paragraph{Caractéristiques de trafic (13 attributs)}
...
\paragraph{Caractéristiques de contenu (19 attributs)}
...
\subsubsection{Taxonomie des attaques}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{8cm}|c|}
        ...
        \hline
        U2R & Élévations de privilèges d'utilisateur normal vers administrateur & buffer\_overflow, rootkit \\
        \hline
    \end{tabular}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/data_distribution.png}
...
Le gain d'information pour un attribut $A$ divisant $S$ en sous-ensembles $\{S_1, S_2, ..., S_v\}$ est :
...
\paragraph{Algorithme de construction}
...
\paragraph{Cas non-linéairement séparable}
...
\subsubsection{Réseaux de neurones multi-couches (MLP)}
...
\subsection{Architecture des modèles spécialisés}

\subsubsection{Autoencodeur pour la détection d'anomalies}

L'autoencodeur constitue l'élément central de notre approche non-supervisée pour la classification binaire.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/autoencoder_architecture.png}
...
\paragraph{Fonction d'activation SELU}
...
\paragraph{Détection d'anomalies}
...
\subsubsection{Réseau de neurones profond pour classification multi-classes}
...
\subsection{Stratégie hiérarchique}

\subsubsection{Étape 1 : Classification binaire}
...
\subsubsection{Étape 2 : Classification des types d'attaques}
...
\subsection{Gestion du déséquilibre : SVM-SMOTE}

\subsubsection{Algorithme SVM-SMOTE}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/smote_illustration.png}
...
\subsubsection{Métriques de base}
...
\subsubsection{Métriques agrégées}
