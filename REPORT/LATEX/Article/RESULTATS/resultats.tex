...
\subsection{Caractérisation du jeu de données NSL-KDD}
...
\subsubsection{Distribution des protocoles et services}
...
\subsubsection{Répartition des classes d'attaques}
...
\subsection{Résultats de la classification binaire}

\subsubsection{Performances comparatives des algorithmes supervisés}
...
\subsubsection{Évaluation de l'autoencodeur}
...
\paragraph{Détermination du seuil optimal}
...
\subsection{Classification multi-classes avec gestion du déséquilibre}

\subsubsection{Impact de la technique SVM-SMOTE}
...
\subsubsection{Performances détaillées par classe d'attaque}
...
\subsection{Analyse comparative et validation}

\subsubsection{Efficacité de l'approche hiérarchique}
